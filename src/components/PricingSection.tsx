...
const sharedFeatures = [
  ...
  { text: "AI Agent — chat conversacional + execução", ai: true },
...
const plans = [
  {
    ...
    desc: "Para começar com foco. Um produto, dados reais, IA e AI Agent trabalhando desde o primeiro dia.",
    star: false,
    cta: "Começar →",
    extras: ["1 produto configurado", "Meta Ads + 1 fonte de receita"],
  },
  {
    name: "Pro",
    price: "10.000",
    scope: "2 a 4 produtos",
    desc: "Escale sua operação com mais produtos integrados e o mesmo nível de inteligência.",
    star: true,
    badge: "Mais popular",
    cta: "Agendar demo →",
    extras: ["2 a 4 produtos", "Billing + NF-e + cobrança automática", "Bônus de performance calculado automaticamente"],
  },
  {
    name: "Scale",
    price: "15.000",
    ...
    extras: ["Produtos ilimitados", "Motor de experimentação A/B", "White-label (domínio próprio)", "Integração Google Ads (em breve)", "Onboarding dedicado + SLA"],
  },
];
  ...
  <section id="pricing" className="py-28 border-t border-border">
    <div className="max-w-[1040px] mx-auto px-7">
      <RevealUp className="text-center mb-14">
        ...
        <p className="text-lg font-light text-gl-g400 leading-[1.75] max-w-[480px] mx-auto">
          Todos os planos incluem AI Agent e todas as funcionalidades. A diferença é só a quantidade de produtos.
        </p>
      </RevealUp>
      ...
      <RevealUp>
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-3.5 items-start">
          {plans.map((plan) => {
            const allFeatures = [...plan.extras, ...sharedFeatures];
            return (
              <div
                key={plan.name}
